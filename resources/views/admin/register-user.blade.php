...
<body>
 ...
 <div class="container">
   ...
   <div class="row justify-content-center">
    ...
    <!-- form -->
    <form method="POST" action="{{ route('register-user.create') }}">
    @csrf
        <div class="row justify-content-center">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="name" id="exampleFormControlInput1" placeholder="@lang('Nombre')..." value="{{ old('name') }}">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="email" id="exampleFormControlInput1" placeholder="@lang('Correo')..." value="{{ old('email') }}">
        ...
        <div class="row justify-content-center mt-3">
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <input type="number" class="form-control" name="identificacion" id="exampleFormControlInput1" placeholder="@lang('identificaciòn')..." value="{{ old('identificacion') }}">
